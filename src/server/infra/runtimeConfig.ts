...
export function loadRuntimeConfig(): RuntimeConfig {
  return {
    ...
    defaultConfigPath: resolveFromRoot(process.env.CONFIG_DEFAULT_PATH, "./data/config.default.json"),
    configPath: resolveFromRoot(process.env.CONFIG_PATH, "./data/config.local.json"),
